...
#(inf -2) * ...                                                                                      |
  ▾(looo)  ▾(olll)      ▾(olll)      ▾(olll)      ▾(olll)      olol → olll  oloo → olll  oool → olll  ▾(oooo)  lool → llll lool → loll  lool → loll  ▾(lool)      ▾(lool)      ▾(lool)     ▾(lool);
#-2 * ...                                                                                            |
...
#(-1 -0.5) * ...                                                                                     |
  ▾(looo)  olol → olll  ▾(olol)      ooll → olol  ▾(olol)      oool → ooll  ▾(oool)      ▾(oool)      ▾(oooo)  ▾(llll)     ▾(llll)      llol → llll  ▾(loll)      loll → llol  ▾(loll)     loll → lool;
#-0.5 * ...                                                                                          |
  ▾(looo)  olol → olll  ▾(oloo)      ▾(ooll)      ▾(oolo)      ▾(oool)      ▾(oool)      ▾(oool)      ▾(oooo)  ▾(llll)     ▾(llll)      ▾(llll)      ▾(lllo)      ▾(llol)      ▾(lloo)     loll → lool;
#(-0.5 0) * ...                                                                                      |
...
#0.5 + ...                                                                                           |
  ▾(looo)  loll → lool  ▾(lloo)      ▾(llol)      ▾(lllo)      ▾(llll)      ▾(llll)      ▾(llll)      ▾(oooo)  ▾(oool)     ▾(oool)      ▾(oool)      ▾(oolo)      ▾(ooll)      ▾(oloo)     olol → olll;
#(0.5 1) * ...                                                                                       |
  ▾(looo)  loll → lool  ▾(loll)      loll → llol  ▾(loll)      llol → llll  ▾(llll)      ▾(llll)      ▾(oooo)  ▾(oool)     ▾(oool)      oool → ooll  ▾(ooll)      ooll → olol  ▾(olol)     olol → olll;
#1 * ...                                                                                             |
...
#(2 inf) + ...                                                                                       |
  ▾(looo)  ▾(lool)      ▾(lool)      ▾(lool)      ▾(lool)      lool → loll  lool → loll  lool → llll  ▾(oooo)  oool → olll oloo → olll  olol → olll  ▾(olll)      ▾(olll)      ▾(olll)     ▾(olll);
]
